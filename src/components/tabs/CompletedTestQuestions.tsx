...
export const CompletedTestQuestions = ({ answers, onEdit }: CompletedTestQuestionsProps) => {
  ...
  // Filter out unanswered questions AND respect original question order
  // This is the key fix - maintain the original order from the questions array
  const completedQuestions = [];
  
  for (const q of questions) {
    if (Boolean(answers[q.id]) && answers[q.id] !== '') {
