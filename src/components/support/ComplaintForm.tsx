...
export const ComplaintForm = () => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
      <div className="flex flex-col mx-auto w-[calc(100%-16px)] max-w-lg animate-fade-in">
        <Card className="glass-card w-full mx-auto overflow-hidden">
          <CardHeader className="p-3 sm:p-6 text-center">
            <CardTitle className="text-lg sm:text-xl md:text-2xl text-white">Reklamation</CardTitle>
            <CardDescription className="text-gray-300 text-xs sm:text-sm md:text-base mt-1">
              Har du problem med en bil du köpt? Skicka in en reklamation här så hjälper vi dig.
            </CardDescription>
          </CardHeader>
              ...
              <DialogTrigger asChild>
                <Button 
                  className="bg-yellow-500 hover:bg-yellow-600 text-black w-full
                    transition-colors text-xs sm:text-sm py-2 font-semibold"
                >
                  Skapa reklamation
                </Button>
              </DialogTrigger>
