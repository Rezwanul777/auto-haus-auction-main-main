...
export const DeliveryAddressCard = ({ address, onSetDefault }: DeliveryAddressCardProps) => {
  return (
    <div className="p-4 rounded-lg bg-black/20 border border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      {!address.is_default && (
        <Button 
          variant="outline"
          className="border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-white w-full md:w-auto"
